...
class Agent:
    ...
    def display_poperties(self):
        for property in self.property_list:
            property.display()
    
    def add_property(self):
        property_type = get_valid_input("what type of property are you after?",("house","apartment")).lower()
        payment_type = get_valid_input("Do you want to purchase of rent?",("purchase","rental")).lower()
